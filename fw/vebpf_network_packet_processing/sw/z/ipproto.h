...
extern	NET_PACKET *new_ippkt_v2(unsigned len);
extern	void	tx_ippkt(NET_PACKET *pkt, unsigned subproto, unsigned src, unsigned dest);
extern	void	tx_ippkt_v2(NET_PACKET *pkt, unsigned subproto, unsigned src, unsigned dest, void *tx_pkt_current_start_mem_address);
