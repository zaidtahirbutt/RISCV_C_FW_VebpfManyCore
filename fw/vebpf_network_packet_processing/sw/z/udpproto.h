...
extern	NET_PACKET *new_udppkt_v2(unsigned len);
extern	void	tx_udp(NET_PACKET *pkt, unsigned dest, unsigned sport, unsigned dport);
extern	void	tx_udp_v2(NET_PACKET *pkt, unsigned dest, unsigned sport, unsigned dport, void *tx_pkt_current_start_mem_address);
extern	void	rx_udp(NET_PACKET *pkt);
extern	void	dump_udppkt(NET_PACKET *pkt);
extern	void	dump_udppkt_v2(NET_PACKET *pkt);
